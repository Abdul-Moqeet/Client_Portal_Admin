...
class _CreateAlertSheetState extends State<CreateAlertSheet> {
  ...
  final _colorCtrl = TextEditingController(text: '#FFC107');
  final _actionLabelCtrl = TextEditingController();
  String _iconName = 'warning';
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final newAlert = AlertAction.fromJson(Map<String, dynamic>.from(response));
      if (mounted) Navigator.pop(context, newAlert);
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return SheetContainer(
      title: 'New Alert',
      subtitle: 'Create a new system alert',
      ...
      child: Column(
        ...
        children: [
          ...
          _isSaving
              ...
              : SheetButton(label: 'Create Alert', onTap: _save),
        ],
      ),
    );
  }
