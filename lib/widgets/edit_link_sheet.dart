...
class _EditLinkSheetState extends State<EditLinkSheet> {
  ...
  void initState() {
    ...
    _iconName = widget.link.iconName ?? 'link';
  }
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final updated = ExternalLink.fromJson(Map<String, dynamic>.from(response));
      if (mounted) Navigator.pop(context, updated);
    } catch (e) {
      debugPrint('Update link failed: $e');
      if (mounted) {
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                value: _iconOptions.contains(_iconName) ? _iconName : 'link',
                isExpanded: true,
