...
#ifndef CLIENT_PORTAL_ADMIN_SWIFT_H
#define CLIENT_PORTAL_ADMIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="client_portal_admin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC19client_portal_admin11AppDelegate")
...
SWIFT_CLASS("_TtC19client_portal_admin17MainFlutterWindow")
